...
class TrxAddingCallable implements Callable {
  TrxAddingListener listener;
  OpTracker opTracker;

  TrxAddingCallable(TrxAddingListener l, OpTracker ot) {
    listener = l; 
    opTracker = ot;
  }
  ...
  public Object call() throws Exception {
    try {
      ...
      next_future.addListener(new TrxAddingListener(listener.client, listener.latch, listener.backoffexp,
